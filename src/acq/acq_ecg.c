...
static void __acq_ecg_acquire_sample(EcgSample *sample) {
    ...
    sample->lod_p = HAL_GPIO_ReadPin(ECG_LOD_P_GPIO_Input_GPIO_Port, ECG_LOD_P_GPIO_Input_Pin);
    sample->lod_n = HAL_GPIO_ReadPin(ECG_LOD_N_GPIO_Input_GPIO_Port, ECG_LOD_N_GPIO_Input_Pin);
}
